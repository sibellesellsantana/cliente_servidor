			...
			public void actionPerformed(ActionEvent e) { 
				...
				try {
					...
					while(true) {
						...
						Servidor servidor = new Servidor(socket, textAreaServidor);
						servidor.start(); 
...
public class FormServidor_ANALISAR2 extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					FormServidor_ANALISAR2 frame = new FormServidor_ANALISAR2();
					frame.setVisible(true);
				} catch (Exception e) {
					e.printStackTrace();
				}
		...
		public void run() {
			...
			try {
				...
				while(true) {
					textAreaServidor.append("Aguardando conexao de cliente...\n");
					Socket socket = serverSocket.accept();
					textAreaServidor.append("Conexao esta aberta com o cliente: " + socket.getInetAddress().toString()+"\n");	
